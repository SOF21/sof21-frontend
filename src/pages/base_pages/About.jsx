...
const images = [
  {
    original:
      "https://s3-eu-west-1.amazonaws.com/lintek-sof/sof-react-page/pages/festival_about/festival1.jpg",
    description: "",
  },
  {
    original:
      "https://s3-eu-west-1.amazonaws.com/lintek-sof/sof-react-page/pages/festival_about/festival2.jpg",
    description: "",
  },
  {
    original:
      "https://s3-eu-west-1.amazonaws.com/lintek-sof/sof-react-page/pages/festival_about/festival3.jpg",
    description: "",
  },
  {
    original:
      "https://s3-eu-west-1.amazonaws.com/lintek-sof/sof-react-page/pages/festival_about/festival4.jpg",
    description: "",
  },
  {
    original:
      "https://s3-eu-west-1.amazonaws.com/lintek-sof/sof-react-page/pages/festival_about/festival5.jpg",
    description: "",
  },
  {
    original:
      "https://s3-eu-west-1.amazonaws.com/lintek-sof/sof-react-page/pages/festival_about/festival6.jpg",
    description: "",
  },
]
        ...
        <Grid className='base-outer-grid base-outer-grid--first'>
          <GridInner>
            ...
            <GridCell phone='4' tablet='8' desktop='12'>
              ...
              <p>
                På grund av den rådande epidemin kan tyvärr inte SOF genomföras
                fysiskt i år, men det ska inte hindra oss. För första gången i
                SOF:s historia presenterar vi: SOF - Digital Edition!
                <br />
                <br />
                Under helgen 13-15 maj bjuder vi härmed in dig till
                livesändningar med tävlingar, aktiviteter, medryckande
                orkestermusik och dans i våra olika kanaler. <br /> Utöver det
                kommer du få möjlighet att beställa hem servicepaket bestående
                av mat, dryck och några exklusiva presenter från oss i
                SOF-organisationen! Vi är ännu inte färdiga med planeringen av
                det digitala upplägget, men vi återkommer med mer information
                närmare inpå festivalen.
                <br />
                <br />
                ...
                >
                  <Ripple>
                    <div
                      ...
                      style={{
                        backgroundImage: "url(" + images[2].original + ")",
                      }}
                ...
                >
                  <Ripple>
                    <div
                      className='cortege-image cortege-image-square-tablet mdc-item-only-hover'
                      style={{
                        backgroundImage: "url(" + images[3].original + ")",
                      }}
...
export default connect(mapStateToProps)(
  withRouter(injectIntl(About, { forwardRef: true }))
)
