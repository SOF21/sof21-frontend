...
const vacantAssigmments = ['cooperation.vice', 'cooperation.spons', 'marketing.vice', 'marketing.pr', 'artDirector.print', 'premises.electrics', 'premises.custodian', 'premises.wifi']
