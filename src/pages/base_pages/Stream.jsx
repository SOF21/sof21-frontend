        ...
        <Grid className='base-outer-grid base-outer-grid--first'>
          <GridInner>
            <GridCell desktop='12' tablet='8' phone='4'>
              <p>
                <FormattedMessage id='Stream.info.p1' />
              </p>
            </GridCell>
            <GridCell desktop='12' tablet='8' phone='4'>
              <p>
                <FormattedMessage id='Stream.info.vote' />
              </p>

              <div id='wufoo-zw8w4fd18pzpde'></div>
            ...
            <GridCell desktop='12' tablet='8' phone='4'>
              <div className='iframe-container'>
                <iframe
                  ...
                  width='560'
                  height='315'
                  src='https://www.youtube.com/embed/GE7l3-xZbxc'
            ...
            <GridCell desktop='12' tablet='8' phone='4'>
              <p className='iframe-container'>
                <iframe
                  ...
                  width='560'
                  height='315'
                  src='https://www.youtube.com/embed/X6VXLTBJopA'
                  title='YouTube video player'
                  frameborder='0'
                  allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture'
                  allowfullscreen
            ...
            <GridCell desktop='12' tablet='8' phone='4'>
              <div className='iframe-container'>
                <iframe
                  ...
                  width='560'
                  height='315'
                  src='https://www.youtube.com/embed/F3-cq7hkorM'
                  title='YouTube video player'
                  frameborder='0'
                  allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture'
                  allowfullscreen
