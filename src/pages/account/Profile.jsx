    ...
    addLiUCardCode(value.liuIDCode)
      .then((res) => {
        this.props.openDialog(
          this.props.intl.formatMessage({ id: "Account.nice" }),
          this.props.intl.formatMessage({ id: "Account.codeSuccess" })
        )
        bag.setSubmitting(false)
      })
      .catch((err) => {
        this.props.openDialog(
          this.props.intl.formatMessage({ id: "Account.bad" }),
          this.props.intl.formatMessage({ id: "Account.badExplain" })
        )
        bag.setSubmitting(false)
      })
  }
          ...
          <Formik
            ...
            validationSchema={Yup.object().shape({
              liuIDCode: Yup.string()
                .test(
                  "len",
                  <FormattedMessage id='Account.code10numbers' />,
                  (val) => val.length === 10
                )
...
export default injectIntl(
  connect(mapStateToProps, { openDialog, setTitle })(Profile)
)
