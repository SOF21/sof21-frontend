  ...
  sv: {
    Cortege: {
      admin: {
        fieldLabels: {
          groupName: "Gruppnamn",
          contactPerson: "Kontaktperson namn",
          mail: "Kontaktperson e-mail",
          phonenumber: "Kontaktperson telefonnummer",
          buildType: "Byggnadstyp",
          contribMotivation: "Beskrivning",
          themeMotivation: "Temamotivation",
      ...
      info: {
        ...
        coronaModal: {
          ...
          p2: "Vanligtvis är Kårtegen det som tar festivalen ut på Linköpings gator och torg, det är en folkfest som drar cirka 50 000 åskådare och alla är välkomna. Den består av orkestrar, baletter och andra studentgrupper som går, spelar, spexar eller åker på egenbyggda flak genom staden.",
          p3: "I år kommer vi i SOF att göra allt vi kan för att trotsa pandemin och sprida den glädje som Kårtegen är känd för. Eftersom det är ett så speciellt år jobbar vi fortfarande på det exakta upplägget för Kårtegen men vår plan är att kårtegebidragen, istället för att rulla genom Linköping, kommer placeras ut på fasta platser runt om i stan. Då får åskådarna möjlighet att själva gå runt och titta på alla byggen. Detaljer om genomförandet kommer närmre inpå kårtegedagen då pandemiläget blir tydligare.",
          p4: "Vår plan är att alla bidrag ska byggas på Byggområdet som är beläget vid märkesbacken på campus Valla, där kommer det serveras både gott att dricka och äta. Byggveckan som pågår i 7 dagar, börjar med Byggstartsfesten och under byggveckan kommer det finnas flera roliga aktiviteter för byggarna att ta del av på området. Byggveckan börjar den 7:e maj och avslutas dagen innan Kårtegen den 14:e maj.",
          p5: "Kårtegen har olika tema varje år som studenterna bygger sina konstruktioner utifrån, klär ut sig till och spexar efter. Temat för årets Kårtege kommer att vara “Fantasivärldar”! Så i år kanske vi får se flygande trollkarlar, en klassisk gestaltning av Batman eller kanske en egen tolkning av Alice i underlandet.",
          p6: "Hoppas ni är lika taggade på Kårtegen som vi är! Skicka in en intresseanmälan här via hemsidan så återkommer vi längre fram. Anmälan är inte bindande och ha överseende med att på grund av rådande läge kan mycket komma att ändras med kort varsel.",
          p7: {
            header: "En ansökan innehåller utöver information om er grupp tre delar:",
            i1: "En grovskiss över bidraget.",
            i2: "En beskrivning av bidraget och vad det innehåller.",
            i3: "En förklaring hur bidraget hänger ihop med Kårtegens tema."
          },
          p8: "Det är just beskrivningen och hur bra ert bidrag passar in i årets tema vi i Kårtegeutskottet kommer att kolla på när vi bestämmer vilka som får möjlighet att vara med i Kårtegen.",
          p9: "Försök tänka utanför ramarna, det kommer inte godkännas flera bidrag som har samma idé.",
          p10: "Det är rekommenderat att ni är mellan 10 och 20 personer i ett bidrag. Däremot kan antalet personer som får vistas på byggområdet samtidigt behöva begränsas för att följa rådande restriktioner.",
          p11: "När ansökan stänger kommer vi att gå igenom alla bidrag och välja ut de vi tycker är bäst lämpade. Om ansökan blir godkänd så kommer vi då be om en mer utförlig ritning samt planerad materialåtgång och ytterligare information.",
          p12: "Kostnaden för ett bidrag är ungefär 4 000 kr. Det som  ingår är material till bygget, verktyg, Byggstartsfest, Byggveckans aktiviteter och SOF21-märke. Betalning sker genom att en klumpsumma för hela gruppen skickas som faktura till gruppens kontaktperson.",
          p13: "Betalning kommer inte att ske förrän efter en anmälan görs (detta är bara en intresseanmälan)",
          p14: {
            a: "Har ni några frågor?",
            b: "Tveka inte att höra av er till kartegeutskottet@sof.lintek.nu",
          },
        }
      },
      ...
      form: {
        ...
        errors: {
          req: {
            groupName: "Du måste ange gruppnamn",
            contactPerson: "Du måste ange en kontaktperson",
            mail: "Du måste ange en e-mail för kontaktpersonen",
            phonenumber: "Du måste ange ett telefonnummer för kontaktpersonen",
            buildType: "Du måste välja byggnadstyp",
            contribMotivation: "Du måste beskriva bygget",
